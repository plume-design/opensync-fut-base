...
from config.model.generic.generators import DefaultGen
from config.model.generic.generators.DefaultGen import generator_names
...
@pytest.fixture(params=[
    ...
    "PP443Z",
    "PP603X"])
def device_ref_leaf(request):
    return request.param


@pytest.fixture(params=['skip', 'ignore', 'xfail'])
def fut_option(request):
    return request.param


def default_gen_instance(device_dut, device_ref_leaf):
    return FutTestConfigGenClass(device_dut, device_ref_leaf, gen_type='optimized').test_generators
...
class TestDefaultGenClass:
    ...
    def test_check_encryption_compatible(self, monkeypatch, encryption):
        ...
        monkeypatch.setattr(default_gen.dut_gw_capabilities, "get", mock_get)
    ...
    def test_generator_names_collected(self):
        generators_dir = "config/model/generic/generators"
    ...
    def test_check_band_compatible(self):
        default_gen = default_gen_instance("PP603X", "PP203X")
        assert default_gen._check_band_compatible("24g", "dut_gw")
        assert not default_gen._check_band_compatible("9g", "dut_gw")
    ...
    def test_check_band_channel_compatible(self, monkeypatch):
        ...
        assert default_gen._check_band_channel_compatible("5g", "44", "dut_gw")
    ...
    def test_check_band_channel_compatible_no_channels(self, monkeypatch):
        ...
        assert not default_gen._check_band_channel_compatible("5g", "44", "dut_gw")
    ...
    def test_parse_fut_opts(self, fut_option):
        ...
        if fut_option == "ignore":
            fut_option = "ignore_collect"
