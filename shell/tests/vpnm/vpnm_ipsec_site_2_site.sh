...
check_ovsdb_table_exist VPN_Tunnel &&
    ...
    raise "VPN_Tunnel table does not exist in ovsdb" -l "vpnm/vpnm_ipsec_site_2_site.sh" -s
...
insert_ovsdb_entry VPN_Tunnel \
    ...
    -i healthcheck_enable false &&
        ...
        raise "insert_ovsdb_entry - VPN_Tunnel" -l "vpnm/vpnm_ipsec_site_2_site.sh" -fc
...
insert_ovsdb_entry IPSec_Config \
    ...
    -i key_exchange "ikev2" &&
        ...
        raise "insert_ovsdb_entry - IPSec_Config" -l "vpnm/vpnm_ipsec_site_2_site.sh" -fc
...
wait_ovsdb_entry VPN_Tunnel \
    ...
    -is tunnel_status "up" &&
        ...
        raise "IPSec s2s VPN tunnel failed to establish" -l "vpnm/vpnm_ipsec_site_2_site.sh" -fc
...
wait_for_function_response 'notempty' "get_ovsdb_entry_value IPSec_State local_subnets -w tunnel_name primary" &&
    ...
    raise "IPSec s2s: local subnets not set in IPSec_State" -l "vpnm/vpnm_ipsec_site_2_site.sh" -fc
...
wait_for_function_response 'notempty' "get_ovsdb_entry_value IPSec_State remote_subnets -w tunnel_name primary" &&
    ...
    raise "IPSec s2s: remote subnets not set in IPSec_State" -l "vpnm/vpnm_ipsec_site_2_site.sh" -fc
