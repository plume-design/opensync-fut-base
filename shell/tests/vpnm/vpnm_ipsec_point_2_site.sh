...
{
cat << usage_string
vpnm/vpnm_ipsec_point_2_site.sh [-h] arguments
Description:
...
Testcase procedure:
    - On DEVICE: Run: ./${manager_setup_file} (see ${manager_setup_file} -h)
                 Run: ./vpnm/vpnm_ipsec_point_2_site.sh
Script usage example:
    ./vpnm/vpnm_ipsec_point_2_site.sh
usage_string
}
...
log "vpnm/vpnm_ipsec_point_2_site.sh: Inserting a VPN_Tunnel row..."
