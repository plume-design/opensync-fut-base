...
update_ovsdb_entry AWLAN_Node \
    ...
    -u firmware_url "$fw_url" &&
        ...
        raise "update_ovsdb_entry - Failed to update AWLAN_Node" -l "um/um_set_upgrade_dl_timer_end.sh" -fc
...
wait_ovsdb_entry AWLAN_Node -is upgrade_status "$fw_start_code" &&
    ...
    raise "wait_ovsdb_entry - AWLAN_Node::upgrade_status is not $fw_start_code" -l "um/um_set_upgrade_dl_timer_end.sh" -tc
