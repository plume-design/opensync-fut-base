...
while [ -n "$1" ]; do
    ...
    case "$option" in
        ...
        -wpa_oftags)
            ...
            ;;
        *)
            raise "Wrong option provided: $option" -l "wm2/wm2_set_radio_thermal_tx_chainmask.sh" -arg
            ;;
    esac
done
            ...
            (
                ...
                create_radio_vif_interface \
                    ...
                    ${create_radio_vif_args} &&
                        log "wm2/wm2_set_radio_thermal_tx_chainmask.sh: create_radio_vif_interface - Interface $radio_if_name created - Success"
            ) ||
