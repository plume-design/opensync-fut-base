...
create_inet_entry \
    ...
    -inet_addr "$inet_addr" &&
        ...
        raise "Failed to create $if_name interface" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -ds
...
wait_for_function_response 0 "check_interface_ip_address_set_on_system $if_name | grep -q \"$inet_addr\"" &&
    ...
    raise "Failed to apply settings to ifconfig (ENABLED #1) for $if_name" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -tc
...
update_ovsdb_entry Wifi_Inet_Config -w if_name "$if_name" -u enabled false &&
    ...
    raise "update_ovsdb_entry - Wifi_Inet_Config::enabled is not 'false'" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -fc
...
wait_ovsdb_entry Wifi_Inet_State -w if_name "$if_name" -is enabled false &&
    ...
    raise "wait_ovsdb_entry - Failed to reflect Wifi_Inet_Config to Wifi_Inet_State::enabled is not 'false'" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -tc
...
wait_for_function_response 1 "check_interface_ip_address_set_on_system $if_name | grep -q \"$inet_addr\"" &&
    ...
    raise "Failed to remove settings from ifconfig (DISABLED #1) for $if_name" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -tc
...
update_ovsdb_entry Wifi_Inet_Config -w if_name "$if_name" -u enabled true &&
    ...
    raise "update_ovsdb_entry - Failed to update Wifi_Inet_Config - enabled=true" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -fc
...
wait_ovsdb_entry Wifi_Inet_State -w if_name "$if_name" -is enabled true &&
    ...
    raise "wait_ovsdb_entry - Failed to reflect Wifi_Inet_Config to Wifi_Inet_State - enabled=true" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -tc
...
wait_for_function_response 0 "check_interface_ip_address_set_on_system $if_name | grep -q \"$inet_addr\"" &&
    ...
    raise "Failed to apply settings to ifconfig (ENABLED #2) - $if_name" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -tc

log "nm2/nm2_ovsdb_remove_reinsert_iface.sh: Setting ENABLED to false"
update_ovsdb_entry Wifi_Inet_Config -w if_name "$if_name" -u enabled false &&
    log "nm2/nm2_ovsdb_remove_reinsert_iface.sh: update_ovsdb_entry - Wifi_Inet_Config table updated - enabled=false - Success" ||
    raise "update_ovsdb_entry - Failed to update Wifi_Inet_Config - enabled=false" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -fc
...
wait_ovsdb_entry Wifi_Inet_State -w if_name "$if_name" -is enabled false &&
    ...
    raise "wait_ovsdb_entry - Failed to reflect Wifi_Inet_Config to Wifi_Inet_State - enabled=false" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -tc
...
wait_for_function_response 1 "check_interface_ip_address_set_on_system $if_name | grep -q \"$inet_addr\"" &&
    ...
    raise "Failed to remove settings from ifconfig (DISABLED #2) for $if_name" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -tc
...
update_ovsdb_entry Wifi_Inet_Config -w if_name "$if_name" -u enabled true -u ip_assign_scheme static &&
    ...
    raise "update_ovsdb_entry - Failed to update Wifi_Inet_Config::enabled is not 'true' and/or Wifi_Inet_Config::ip_assign_scheme is not 'static'" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -fc
...
wait_ovsdb_entry Wifi_Inet_State -w if_name "$if_name" -is enabled true -is ip_assign_scheme static &&
    ...
    raise "wait_ovsdb_entry - Failed to reflect Wifi_Inet_Config to Wifi_Inet_State::enabled is not true and/or Wifi_Inet_State::ip_assign_scheme is not 'static'" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -tc
...
wait_for_function_response 0 "check_interface_ip_address_set_on_system $if_name | grep -q \"$inet_addr\"" &&
    ...
    raise "Failed to apply settings to ifconfig (ENABLED #3) - $if_name" -l "nm2/nm2_ovsdb_remove_reinsert_iface.sh" -tc
