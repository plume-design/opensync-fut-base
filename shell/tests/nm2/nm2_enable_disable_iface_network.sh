...
create_inet_entry \
    ...
    -inet_addr "$inet_addr" &&
        ...
        raise "Failed to create $if_name interface" -l "nm2/nm2_enable_disable_iface_network.sh" -ds
...
wait_for_function_response 0 "check_interface_ip_address_set_on_system $if_name | grep -q \"$inet_addr\"" &&
    ...
    raise "Failed to apply settings to ifconfig - IP: $inet_addr" -l "nm2/nm2_enable_disable_iface_network.sh" -tc
...
update_ovsdb_entry Wifi_Inet_Config -w if_name "$if_name" -u network false &&
    ...
    raise "update_ovsdb_entry - Wifi_Inet_Config::network is not 'false'" -l "nm2/nm2_enable_disable_iface_network.sh" -fc
...
wait_ovsdb_entry Wifi_Inet_State -w if_name "$if_name" -is network false &&
    ...
    raise "wait_ovsdb_entry - Failed to reflect Wifi_Inet_Config to Wifi_Inet_State::network is not 'false'" -l "nm2/nm2_enable_disable_iface_network.sh" -tc
...
wait_for_function_response 1 "check_interface_ip_address_set_on_system $if_name | grep -q \"$inet_addr\"" &&
    ...
    raise "Failed to remove settings from ifconfig for '$if_name'" -l "nm2/nm2_enable_disable_iface_network.sh" -tc
...
update_ovsdb_entry Wifi_Inet_Config -w if_name "$if_name" -u network true &&
    ...
    raise "update_ovsdb_entry - Wifi_Inet_Config::network is not 'true'" -l "nm2/nm2_enable_disable_iface_network.sh" -fc
...
wait_ovsdb_entry Wifi_Inet_State -w if_name "$if_name" -is network true &&
    ...
    raise "wait_ovsdb_entry - Failed to reflect Wifi_Inet_Config to Wifi_Inet_State::network is not 'true'" -l "nm2/nm2_enable_disable_iface_network.sh" -tc
