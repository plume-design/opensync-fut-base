...
The test case requires one additional LEAF device and two CLIENT devices. One CLIENT device is connected to the GW,
and the other is connected to the LEAF.
